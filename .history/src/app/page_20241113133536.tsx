...
active:text-[var(--main-color)]"
      ...
      <section className={`home bg-[url('../../public/fullSizeImge1.jpg')] bg-cover bg-center transition-opacity duration-300 ${isSidebarOpen ? "opacity-50" : "opacity-100"}`} id="home">
        <div className="home-content">
          ...
          <p>
          I'm a passionate Full Stack Developer currently honing my skills at GIAIC. On the front-end, I've mastered Next.js and Tailwind CSS to create responsive and dynamic user interfaces. As my journey progresses, I'm delving deeper into back-end technologies to build comprehensive, full-stack applications. Stay tuned as I expand my skill set and bring innovative ideas to life!I’m 
          </p>
