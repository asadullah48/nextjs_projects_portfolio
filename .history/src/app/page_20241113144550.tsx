            ...
            <div className="education-box">
              ...
              <div className="education-content">
                <div className="content">
                  ...
                  <p>A skill enhancement app is a mobile or web application designed to help users improve their skills and knowledge in various areas. These apps often provide resources such as:
